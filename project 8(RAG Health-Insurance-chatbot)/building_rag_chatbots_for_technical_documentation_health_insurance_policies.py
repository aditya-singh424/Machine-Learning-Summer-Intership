# -*- coding: utf-8 -*-
"""Building_RAG_Chatbots_for_Technical_Documentation_Health_Insurance_Policies.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Qa6n2IpzuallHZuog0soDd440ZhrSQkn

# Building RAG Chatbots for Health Insurance

## A Detailed Overview of the Different Types of Health Insurance Plans

A machine dashboard with lots of new technical features.

You're working for a well-known company Star Health who is looking at implementing LLMs into Healthcare Sector to provide guidance to patients. You've been asked to experiment with integrating Healthcare Insurance manuals with an LLM to create a context-aware chatbot. They hope that this context-aware LLM can be hooked up to a text-to-speech software to read the model's response aloud.

As a proof of concept, you'll integrate several pages from a Star Health Insurance manual that contains Healthcare realted Knowledge base and their meanings and recommended actions. This particular manual, stored as an HTML file, `https://www.samsung.com/levant/support/home-appliances/how-to-use-the-various-modes-of-the-washing-machine/`, is from an Starhealth company, a healthcare provider. Armed with your newfound knowledge of LLMs and LangChain, you'll implement Retrieval Augmented Generation (RAG) to create the context-aware chatbot.
...
**Dataset input Star Health Insurance:**

Download this web page in your local system and then read from relevant address:

Different Health Insurance Plans and the Suitable Beneficiaries:
https://www.starhealth.in/health-insurance/types-of-health-insurance/

Sample Query:

Q1. What are different Maternity Health Insurance Plan in StarHealth?

Q.2. What benefits do Health Insurance policies offer?

Q.3. Why should you get a Health Insurance policy when you’re young?

Q.4. How many types of health insurance policies are there?

Q.5. What are the different types of health insurance schemes in India?
"""
...
loader = UnstructuredHTMLLoader(file_path="/content/starhealth.html")
...
os.environ["OPENAI_API_KEY"] = "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"
