...
st.set_page_config(
    page_title="Interactive Iris Cluster Explorer",
    page_icon="🌸",
    layout="wide",
...
st.sidebar.markdown("Adjust clustering settings below.")
...
# ----------------- Top Header -----------------
st.markdown('<div class="prof-title">Interactive Iris Cluster Explorer</div>', unsafe_allow_html=True)
st.markdown('<div class="prof-subtitle">Visual exploration of Iris flower clusters using K-Means</div>', unsafe_allow_html=True)
